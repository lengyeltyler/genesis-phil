...
The execution layer checks the release-bound launch policy before passkey approval and again before submission. Production deployment starts closed; one designated funded, backup-verified account is used for the remaining acceptance mint. Public enablement uses the same artifact after receipt, ownership, artwork and journal verification. No repeated setup or acceptance mint is required.
