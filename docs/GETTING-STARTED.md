# Install and mint with Phil — Build 97

[Back to download](../README.md)

Use an Apple Silicon Mac. Build 97 targets macOS 12 or later; physical testing on every older macOS version has not been completed. The Desktop installer targets Apple Silicon macOS. The separate browser application is available at [Phil Web](https://phil.tylerlengyel.com); its passkey and backup flows differ from Desktop.

## Install or update

1. Download [Phil-0.3.0-97-macOS-arm64.dmg](https://github.com/lengyeltyler/genesis-phil/releases/download/v0.3.0-build97/Phil-0.3.0-97-macOS-arm64.dmg).
