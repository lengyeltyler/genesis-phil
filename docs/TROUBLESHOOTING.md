...
| Withdraw asks for an amount | In Build 97, select **Withdraw all — gas deducted automatically** and enter the recipient. Custom amounts are optional and accept normal decimals. |
