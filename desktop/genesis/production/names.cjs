...
const {N}=require('../scripts/recipes.cjs');
...
function randomNameId(){return BigInt(randomInt(100)<30?randomInt(1,161):randomInt(161,Number(NAME_COUNT)+1));}
module.exports={NAME_COUNT,validNameId,generatedName,tokenName,encodeChoice,decodeChoice,randomNameId};
